...
function normalizeProps (options, vm) {
  ...
  if (Array.isArray(props)) {
    ...
    for (var key in props) {
      val = props[key];
      name = camelize(key);
      if ("production" !== 'production' && isPlainObject(val)) {
...
exports.default = {
    ...
    mounted: function mounted() {
        ...
        for (var i = 0; i <= 3; i++) {
            ...
            dishTl.add(TweenMax.fromTo($(this.$refs['dish' + (i + 1)]), tweenTime, {
                opacity: 0
            }, {
                opacity: 1
            }), delayTime * i);
            dishTl.add(TweenMax.to($(this.$refs['dish' + (i + 1)]), tweenTime, {
                opacity: 0
            }), '+=' + delayTime);
        }

        var coverTlTweenTime = 0.6;
        var coverTlPaddingTime = '-=0.3';

        coverTl.add(TweenMax.fromTo($(this.$refs.title), coverTlTweenTime, {
            opacity: 0,
            y: -50
        }, {
            opacity: 1,
        ...
        coverTl.add(TweenMax.fromTo($(this.$refs.cover), coverTlTweenTime, {
            opacity: 0,
            y: -50
        }, {
            opacity: 1,
        ...
        coverTl.add(TweenMax.fromTo($(this.$refs.keys), coverTlTweenTime, {
            opacity: 0,
            y: -50
        }, {
            opacity: 1,
        ...
        coverTl.add(TweenMax.fromTo($(this.$refs.note), coverTlTweenTime, {
            opacity: 0,
            y: -50
        }, {
            opacity: 1,
...
__vue__options__.render = function(){with(this){return _c('section',{staticClass:"index"},[_c('div',{staticClass:"index__hd"}),_c('div',{staticClass:"index__bd"},[_c('div',{staticClass:"index__content"},[_c('div',{staticClass:"l-container"},[_c('div',{staticClass:"l-vm"},[_c('div',{staticClass:"l-vm__content"},[_c('div',{ref:"title",staticClass:"index__title hide-text"},[_v("麵包大解密 安心飲食新指標")]),_c('div',{ref:"cover",staticClass:"index__cover"},[_c('div',{ref:"dish1",staticClass:"index__dish index__dish--1"}),_c('div',{ref:"dish2",staticClass:"index__dish index__dish--2"}),_c('div',{ref:"dish3",staticClass:"index__dish index__dish--3"}),_c('div',{ref:"dish4",staticClass:"index__dish index__dish--4"})]),_c('div',{ref:"keys",staticClass:"index__keys"},[_c('a',{staticClass:"index__keys__item index__keys__item--1 hide-text",attrs:{"href":"key.1.html"}},[_v("安心關鍵1 麵包保鮮")]),_c('a',{staticClass:"index__keys__item index__keys__item--2 hide-text",attrs:{"href":"key.2.html"}},[_v("安心關鍵2 一致的品質")]),_c('a',{staticClass:"index__keys__item index__keys__item--3 hide-text",attrs:{"href":"key.3.html"}},[_v("安心關鍵3 飲食安全")])]),_c('div',{ref:"note",staticClass:"index__note hide-text"})])])]),_c('a',{staticClass:"index__link-test hide-text",attrs:{"href":"test.html"}},[_v("麵包大會考")])])]),_c('div',{staticClass:"index__ft"})])}}
...
var _Key = require('./Key1.vue');

var _Key2 = _interopRequireDefault(_Key);

var _Key3 = require('./Key2.vue');

var _Key4 = _interopRequireDefault(_Key3);

var _Key5 = require('./Key3.vue');
...
exports.default = {
    ...
    methods: {
        showPop: function showPop(e, itemOrder) {
...
if (module.exports.__esModule) module.exports = module.exports.default
var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
__vue__options__.render = function(){with(this){return _c('section',{staticClass:"key key2",attrs:{"id":"key"}},[_c('div',{staticClass:"key__hd"}),_c('div',{staticClass:"key__bd"},[_c('div',{staticClass:"l-container"},[_c('section',{staticClass:"key__content"},[_c('h1',{staticClass:"key__title"},[_v("安心關鍵 2 一張圖看懂 麵包一致的品質關鍵 30年麵包師傅：紀律，才能確保每一口最佳口感！")]),_c('div',{staticClass:"key__flow"},[_m(0),_m(1),_c('div',{staticClass:"key__items"},[_c('div',{staticClass:"key__item key__item--1 gtm-event",attrs:{"data-category":"bread-click","data-action":"popup-click","data-label":"安心關鍵 1 :麵包專業講解：紀律X時間，換取一致的品質"},on:{"click":function($event){showPop($event, 0)}}},[_c('span',{staticClass:"title hide"},[_v("麵包專業講解：紀律X時間，換取一致的品質")]),_c('span',{staticClass:"content hide"},[_v("「每一個麵包都能享受到同樣的幸福，才能讓消費者吃到的都是一樣新鮮和口感的麵包！」高品質麵包不只需要研發者的用心，更需要製程上所有人員的專業和嚴格控管，相較於一般的烘焙坊，機製麵包有專業製程與把關，才能每天為國人供應超過30萬一致的高品質麵包！")]),_c('span',{staticClass:"pc"}),_c('span',{staticClass:"mb"}),_c('div',{staticClass:"icon"})]),_c('div',{staticClass:"key__item key__item--2 gtm-event",attrs:{"data-category":"bread-click","data-action":"popup-click","data-label":"安心關鍵 1 :專業細節1：人員專業及研發力"},on:{"click":function($event){showPop($event, 1)}}},[_c('span',{staticClass:"title hide"},[_v("專業細節1：人員專業及研發力")]),_c('span',{staticClass:"content hide"},[_v("高品質的製程從第一線人員開始，工廠的創新速度(專利申請)和員工的專業程度(國家級證照)，都直接影響每個產品的品質！")]),_c('span',{staticClass:"pc"}),_c('span',{staticClass:"mb"}),_c('div',{staticClass:"icon"})]),_c('div',{staticClass:"key__item key__item--3 gtm-event",attrs:{"data-category":"bread-click","data-action":"popup-click","data-label":"安心關鍵 1 :專業細節2：長時間中種法"},on:{"click":function($event){showPop($event, 2)}}},[_c('span',{staticClass:"title hide"},[_v("專業細節2：長時間中種法")]),_c('span',{staticClass:"content hide"},[_v("麵包要美味一刻也急不得！相較一般烘焙採取短時間直接法；長時間低溫培養，才能讓酵母菌和乳酸菌充分地活化，代謝產生的有機酸、酵素與麵糰作用，才能完整釋放出熟成的香氣、品質更柔軟細緻。不用添加物也能香郁美味！")]),_c('span',{staticClass:"pc"}),_c('span',{staticClass:"mb"}),_c('div',{staticClass:"icon"})]),_c('div',{staticClass:"key__item key__item--4 gtm-event",attrs:{"data-category":"bread-click","data-action":"popup-click","data-label":"安心關鍵 1 :專業細節3：自製老麵種"},on:{"click":function($event){showPop($event, 3)}}},[_c('span',{staticClass:"title hide"},[_v("專業細節3：自製老麵種")]),_c('span',{staticClass:"content hide"},[_v("低溫熟成的自製老麵種產生乳酸及醋酸等有機酸降低麵糰的pH值，能夠抑制雜菌的生長，讓麵包的賞味期限得以延長，柔軟鮮度能維持得更久。")]),_c('span',{staticClass:"pc"}),_c('span',{staticClass:"mb"}),_c('div',{staticClass:"icon"})]),_c('div',{staticClass:"key__item key__item--5 gtm-event",attrs:{"data-category":"bread-click","data-action":"popup-click","data-label":"安心關鍵 1 :專業細節4：自動生產的輔助"},on:{"click":function($event){showPop($event, 4)}}},[_c('span',{staticClass:"title hide"},[_v("專業細節4：自動生產的輔助")]),_c('span',{staticClass:"content hide"},[_v("手工+機器做出來的麵包，比全手工更有品質！手工難免有技術侷限和不穩定度，機器可以成為很好的輔助。例如手工包餡的時候很難掌控，但包餡機就能做到皮薄餡多、均勻分布，確保最完美的口感。")]),_c('span',{staticClass:"pc"}),_c('span',{staticClass:"mb"}),_c('div',{staticClass:"icon"})])])]),_m(2),_c('a',{staticClass:"index__link-test hide-text",attrs:{"href":"test.html"}},[_v("麵包大會考")])])])])])}}
__vue__options__.staticRenderFns = [function(){with(this){return _c('div',{staticClass:"key__flow__main"},[_c('div',{staticClass:"key__flow__bread key__flow__bread--1"}),_c('div',{staticClass:"key__flow__box key__flow__box--1"}),_c('div',{staticClass:"key__flow__bread key__flow__bread--2"}),_c('div',{staticClass:"key__flow__box key__flow__box--2"}),_c('div',{staticClass:"key__flow__line"}),_c('div',{staticClass:"key__flow__bread key__flow__bread--3"})])}},function(){with(this){return _c('div',{staticClass:"key__anis"},[_c('div',{staticClass:"key__ani key__ani--1"}),_c('div',{staticClass:"key__ani key__ani--2"}),_c('div',{staticClass:"key__ani key__ani--3"}),_c('div',{staticClass:"key__ani key__ani--4"}),_c('div',{staticClass:"key__ani key__ani--5"})])}},function(){with(this){return _c('div',{staticClass:"key__end"},[_c('div',{staticClass:"key__share"},[_c('div',{staticClass:"key__share__item square_fb"},[_c('div',{staticClass:"fb-share-button",attrs:{"data-href":"http://topic.commonhealth.com.tw/pecos-bread/key.2.html","data-layout":"button","data-size":"small","data-mobile-iframe":"true"}},[_c('a',{staticClass:"fb-xfbml-parse-ignore",attrs:{"target":"_blank","href":"https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2F[object Object]&src=sdkpreparse"}},[_v("分享")])])]),_c('div',{staticClass:"key__share__item square_line"},[_c('div',{staticClass:"line-it-button",staticStyle:{"display":"none"},attrs:{"data-lang":"zh_Hant","data-type":"share-c","data-url":"http://topic.commonhealth.com.tw/pecos-bread/key.2.html"}})]),_c('div',{staticClass:"key__share__item square_tw"},[_c('a',{staticClass:"twitter-share-button",attrs:{"href":"https://twitter.com/intent/tweet?text=康健x統一麵包  安心關鍵 2 一張圖看懂 麵包一致的品質關鍵 30年麵包師傅：紀律，才能確保每一口最佳口感！&url=http://topic.commonhealth.com.tw/pecos-bread/key.2.html","data-size":"large"}})]),_c('div',{staticClass:"key__share__item square_gl"},[_c('div',{staticClass:"g-plus",attrs:{"data-action":"share","data-width":"120","data-height":"24","data-href":"http://topic.commonhealth.com.tw/pecos-bread/key.2.html"}})])]),_c('div',{staticClass:"key__end__note"}),_c('div',{staticClass:"key__end__ctrls"},[_c('a',{staticClass:"prev",attrs:{"href":"key.1.html"}},[_v("上個關鍵：麵包保鮮")]),_c('a',{staticClass:"next",attrs:{"href":"key.3.html"}},[_v("下個關鍵：麵包飲食安全")])])])}}]
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  module.hot.accept()
...
if (module.exports.__esModule) module.exports = module.exports.default
var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
__vue__options__.render = function(){with(this){return _c('section',{staticClass:"key key3",attrs:{"id":"key"}},[_c('div',{staticClass:"key__hd"}),_c('div',{staticClass:"key__bd"},[_c('div',{staticClass:"l-container"},[_c('section',{staticClass:"key__content"},[_c('h1',{staticClass:"key__title"},[_v("安心關鍵 3 一張圖看懂 麵包飲食安全關鍵 食安微角落靠專業自律！烘焙業龍頭大廠這樣做")]),_c('div',{staticClass:"key__flow"},[_m(0),_m(1),_c('div',{staticClass:"key__items"},[_c('div',{staticClass:"key__item key__item--1 gtm-event",attrs:{"data-category":"bread-click","data-action":"popup-click","data-label":"安心關鍵 1 :麵包專業講解：<br/>食安微角落的自律把關才有食品安全!"},on:{"click":function($event){showPop($event, 0)}}},[_c('span',{staticClass:"title hide"},[_v("麵包專業講解：<br/>食安微角落的自律把關才有食品安全!")]),_c('span',{staticClass:"content hide"},[_v("食品真的是良心事業！平價產品卻有高標準、高成本的自律機制，麵包製程不複雜，但食品安全關鍵在於魔鬼細節，幾大關鍵點是民眾和其他烘焙業者要參考學習的。")]),_c('span',{staticClass:"pc"}),_c('span',{staticClass:"mb"}),_c('div',{staticClass:"icon"})]),_c('div',{staticClass:"key__item key__item--2 gtm-event",attrs:{"data-category":"bread-click","data-action":"popup-click","data-label":"安心關鍵 1 :專業細節1：嚴格採購原則原料品質把關"},on:{"click":function($event){showPop($event, 1)}}},[_c('span',{staticClass:"title hide"},[_v("專業細節1：嚴格採購原則原料品質把關")]),_c('span',{staticClass:"content hide"},[_v("原料的品質和等級每批都不同，內部要訂定嚴格的採購原則，確保產品的食安品質。例如不得含防腐劑、到貨的原料保存期限，在採購時捨棄能降低成本的大量購買，而是用少量訂單的方式逐批採購，維持原料的鮮度。")]),_c('span',{staticClass:"pc"}),_c('span',{staticClass:"mb"}),_c('div',{staticClass:"icon"})]),_c('div',{staticClass:"key__item key__item--3 gtm-event",attrs:{"data-category":"bread-click","data-action":"popup-click","data-label":"安心關鍵 1 :專業細節2：溯源管理原料源頭把關"},on:{"click":function($event){showPop($event, 2)}}},[_c('span',{staticClass:"title hide"},[_v("專業細節2：溯源管理原料源頭把關")]),_c('span',{staticClass:"content hide"},[_v("食安危機常出現於源頭，大型的烘焙品牌才有力量前往源頭要求與檢驗。以雞蛋為例，從畜牧場使用的水、飼料、養殖環境，到液蛋的藥物殘留檢測、液蛋全程運輸溫控，都是食安的重要把關作為。")]),_c('span',{staticClass:"pc"}),_c('span',{staticClass:"mb"}),_c('div',{staticClass:"icon"})]),_c('div',{staticClass:"key__item key__item--4 gtm-event",attrs:{"data-category":"bread-click","data-action":"popup-click","data-label":"安心關鍵 1 :專業細節3：嚴格原料及成品檢驗"},on:{"click":function($event){showPop($event, 3)}}},[_c('span',{staticClass:"title hide"},[_v("專業細節3：嚴格原料及成品檢驗")]),_c('span',{staticClass:"content hide"},[_v("食品大廠除了能有嚴密的供應商管理，將採購風險降到最低，進廠生產到出貨也需要嚴格「自主檢驗」。例如金屬、包裝等食安指標檢測，確認安全無虞才能出貨。")]),_c('span',{staticClass:"pc"}),_c('span',{staticClass:"mb"}),_c('div',{staticClass:"icon"})]),_c('div',{staticClass:"key__item key__item--5 gtm-event",attrs:{"data-category":"bread-click","data-action":"popup-click","data-label":"安心關鍵 1 :專業細節4：烹飪器皿的安全性"},on:{"click":function($event){showPop($event, 4)}}},[_c('span',{staticClass:"title hide"},[_v("專業細節4：烹飪器皿的安全性")]),_c('span',{staticClass:"content hide"},[_v("烹飪器皿的材質風險、過度使用都可能導致食安問題的發生，任何細節都不可輕忽。例如烤盤的使用紀錄、定期更換，在所有接觸到原料的器具材質也都應有嚴格的要求。")]),_c('span',{staticClass:"pc"}),_c('span',{staticClass:"mb"}),_c('div',{staticClass:"icon"})]),_c('div',{staticClass:"key__item key__item--6 gtm-event",attrs:{"data-category":"bread-click","data-action":"popup-click","data-label":"安心關鍵 1 :專業細節5：體制外食安中心監督"},on:{"click":function($event){showPop($event, 5)}}},[_c('span',{staticClass:"title hide"},[_v("專業細節5：體制外食安中心監督")]),_c('span',{staticClass:"content hide"},[_v("除了自主管理，第三方單位的不定期抽檢也是食安維護不懈怠的動能。專業良心的食品品牌會有「食安警察」機制，隨時把關風險、嚴格監控，幫助民眾安心飲食。")]),_c('span',{staticClass:"pc"}),_c('span',{staticClass:"mb"}),_c('div',{staticClass:"icon"})])])]),_m(2),_c('a',{staticClass:"index__link-test hide-text",attrs:{"href":"test.html"}},[_v("麵包大會考")])])])])])}}
__vue__options__.staticRenderFns = [function(){with(this){return _c('div',{staticClass:"key__flow__main"},[_c('div',{staticClass:"key__flow__bread key__flow__bread--1"}),_c('div',{staticClass:"key__flow__box key__flow__box--1"}),_c('div',{staticClass:"key__flow__bread key__flow__bread--2"}),_c('div',{staticClass:"key__flow__box key__flow__box--2"}),_c('div',{staticClass:"key__flow__line"}),_c('div',{staticClass:"key__flow__bread key__flow__bread--3"})])}},function(){with(this){return _c('div',{staticClass:"key__anis"},[_c('div',{staticClass:"key__ani key__ani--1"}),_c('div',{staticClass:"key__ani key__ani--2"}),_c('div',{staticClass:"key__ani key__ani--3"}),_c('div',{staticClass:"key__ani key__ani--4"}),_c('div',{staticClass:"key__ani key__ani--5"})])}},function(){with(this){return _c('div',{staticClass:"key__end"},[_c('div',{staticClass:"key__share"},[_c('div',{staticClass:"key__share__item square_fb"},[_c('div',{staticClass:"fb-share-button",attrs:{"data-href":"http://topic.commonhealth.com.tw/pecos-bread/key.3.html","data-layout":"button","data-size":"small","data-mobile-iframe":"true"}},[_c('a',{staticClass:"fb-xfbml-parse-ignore",attrs:{"target":"_blank","href":"https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2F[object Object]&src=sdkpreparse"}},[_v("分享")])])]),_c('div',{staticClass:"key__share__item square_line"},[_c('div',{staticClass:"line-it-button",staticStyle:{"display":"none"},attrs:{"data-lang":"zh_Hant","data-type":"share-c","data-url":"http://topic.commonhealth.com.tw/pecos-bread/key.3.html"}})]),_c('div',{staticClass:"key__share__item square_tw"},[_c('a',{staticClass:"twitter-share-button",attrs:{"href":"https://twitter.com/intent/tweet?text=康健x統一麵包 安心關鍵 1 一張圖看懂 麵包保鮮關鍵 保鮮術？兼顧安心美味的製程秘密！&url=http://topic.commonhealth.com.tw/pecos-bread/key.3.html","data-size":"large"}})]),_c('div',{staticClass:"key__share__item square_gl"},[_c('div',{staticClass:"g-plus",attrs:{"data-action":"share","data-width":"120","data-height":"24","data-href":"http://topic.commonhealth.com.tw/pecos-bread/key.3.html"}})])]),_c('div',{staticClass:"key__end__note"}),_c('div',{staticClass:"key__end__ctrls"},[_c('a',{staticClass:"prev",attrs:{"href":"key.2.html"}},[_v("上個關鍵：麵包一致的品質")])])])}}]
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  module.hot.accept()
...
exports.default = {
    ...
    data: function data() {
        return {
            ...
            questions: [{
                ...
                type: '包裝麵包認知題',
                options: ['原料、營養標示、<br>過敏原宣稱', '製造日期、<br>保存期限', '以上皆是']
            }, {
                ...
                type: '包裝麵包認知題',
                options: ['<img src="./images/qa-logo.png">', '<img src="./images/qa-logo.png">']
            }, {
                title: '哪種麵包的製作方法，需費時較長時間？',
                type: '麵包達人得分題',
                options: ['我知道，是直接法<span>Straight-Dough<br/>Metho</span>', '我超懂，是中種法<span>Sponge-Dough<br/>Method</span>']
            }, {
    ...
    mounted: function mounted() {
        ...
        _firebase.database().ref().on('value', function (snapshot) {
            _this.lvTotalCount = {
    ...
    timeInterval: null,
    methods: {
        resetTimeCount: function resetTimeCount() {
            var _this2 = this;

            this.timeCount = 5;
            this.timeInterval = setInterval(function () {
                var time = _this2.timeCount;
                if (_this2.timeCount <= 0) {
                    clearInterval(_this2.timeInterval);
                    _this2.checkAns(_this2.currentQuestion, -1);
                } else {
                    time--;
                    _this2.timeCount = time;
                }
            }, 1000);
        },
        resetToNextQuestion: function resetToNextQuestion() {
        ...
        checkAns: function checkAns(questionIndex, ans) {
            var _this3 = this;

            this.selectedAns[this.currentQuestion] = ans;
            var isOk = ans == this.ans[questionIndex];
            ...
            if (this.currentQuestion < 7) {
                setTimeout(function () {
                    _this3.resetToNextQuestion();
                }, 1500);
            } else {
                //送出作答結果，等待後 轉到結果頁 帶網址參數
                var correctCount = 0;
                $(this.selectedAnsResult).each(function (index, item) {
                    if (item) {
                        correctCount++;
                    }
                });
        ...
        submitResult: function submitResult(correctCount) {
            var resultLv = 1;
            ...
            _firebase.database().ref().update(updateData, function (error) {
                setTimeout(function () {
        ...
        selectedOption: function selectedOption(e, questionIndex, ans) {
            e.preventDefault();
...
var _ResultChart = require('./ResultChart.vue');

var _ResultChart2 = _interopRequireDefault(_ResultChart);

var _ResultLibarys = require('./ResultLibarys.vue');

var _ResultLibarys2 = _interopRequireDefault(_ResultLibarys);
...
exports.default = {
    name: 'Result',
    components: {
        ResultChart: _ResultChart2.default,
        ResultLibarys: _ResultLibarys2.default
    },
    props: [],
    data: function data() {
        return {
    ...
    mounted: function mounted() {
        ...
        var userCorrectcCount = url.searchParams.get('count') || 0;
...
exports.default = {
    ...
    mounted: function mounted() {
        ...
        _firebase.database().ref().on('value', function (snapshot) {
            _this.lv1Count = snapshot.child('lv1Count').val();
            _this.lv2Count = snapshot.child('lv2Count').val();
            _this.lv3Count = snapshot.child('lv3Count').val();

            _this.totalSum = _this.lv1Count + _this.lv2Count + _this.lv3Count;
            _this.lv1DisplayNumber = Math.floor(_this.lv1Count / _this.totalSum * 100);
            _this.lv2DisplayNumber = Math.floor(_this.lv2Count / _this.totalSum * 100);
            _this.lv3DisplayNumber = 100 - _this.lv1DisplayNumber - _this.lv2DisplayNumber;
    ...
    methods: {
        runChart: function runChart() {
            ...
            tl.add(TweenMax.fromTo($(this.$refs.bar1), 1, {
                height: '0%'
            }, {
                height: bar1Height + '%'
            }), 0);

            tl.add(TweenMax.fromTo($(this.$refs.user), 1, {
                transformOrigin: '50% 50%',
                x: '-' + (peopleWidth / 2 - 5) + 'px'
            }, {
                x: this.userCorrectcCount / 8 * canvasWidth - peopleWidth / 2 + 5 + 'px'
            }), 0);
            tl.add(TweenMax.fromTo($(this.$refs.userDisplayBar), 1, {
                width: 0 + '%'
            }, {
                width: this.userCorrectcCount / 8 * 100 + '%'
            }), 0);

            tl.add(TweenMax.fromTo($(this.$refs.bar2), 1, {
                height: '0%'
            }, {
                height: bar2Height + '%'
            }), '-=1');
            tl.add(TweenMax.fromTo($(this.$refs.bar3), 1, {
                height: '0%'
            }, {
                height: bar3Height + '%'
            }), '-=1');
...
exports.default = {
    ...
    computed: {},
    mounted: function mounted() {
        var dContent = $(this.$refs['content' + this.currentOpened]);
        dContent.slideDown();
    },

    methods: {
        toogleLibary: function toogleLibary(event, targetId) {
            var dContent = $(this.$refs['content' + targetId]);
            if (targetId == this.currentOpened) {
                dContent.slideUp();
                this.currentOpened = 0;
            } else {
                this.currentOpened = targetId;
                dContent.slideDown();
            }
        }
    }
...
exports.default = {
    ...
    mounted: function mounted() {
        ...
        coverTl.add(TweenMax.fromTo($(this.$refs.ctrls), coverTlTweenTime, {
            opacity: 0,
            y: -50
        }, {
            opacity: 1,
...
var _Key = require('./components/Key.vue');

var _Key2 = _interopRequireDefault(_Key);

var _Qa = require('./components/Qa.vue');

var _Qa2 = _interopRequireDefault(_Qa);

var _Result = require('./components/Result.vue');
...
if ($('#key').length > 0) {
    new _vue2.default({
        ...
        render: function render(createElement) {
            ...
            return createElement(_Key2.default, {
                props: {
...
if ($('#result').length > 0) {
    ...
    new _vue2.default({
        ...
        render: function render(createElement) {
            ...
            return createElement(_Result2.default, {
                props: {}
            });
        }
    });
